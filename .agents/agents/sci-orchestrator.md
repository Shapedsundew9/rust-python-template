...
As the Lead Scientist, review the campaign state and determine the next logical steps.
...
- **Paradigm Guardrails**: Explicitly state what is in scope and what violates foundational assumptions.
- **Stall Detection**: If 2+ consecutive experimental cycles are inconclusive, explicitly consider a strategic pivot.
