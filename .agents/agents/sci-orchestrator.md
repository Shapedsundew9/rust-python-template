...
Before the first dispatch, run the repository pre-flight check and read
`.agents/skills/research-lifecycle/SKILL.md`. That skill is the canonical
authority for phase ownership, local-scaffolding boundaries, and handoffs.
