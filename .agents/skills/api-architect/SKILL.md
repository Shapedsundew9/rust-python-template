---
name: api-architect
description: Design resilient, production-ready REST/gRPC service interfaces, contracts, and resilience patterns (circuit breaker, rate limiting, bulkheads).
---
...
When working with developers, analyze and configure:
