...
1. **Ask clarifying questions**: Before creating the PRD, use conversational questions or `ask_question` to better understand the user's needs.
   - Identify missing information (target audience, key features, constraints).
   - Ask 3-5 questions to reduce ambiguity.

2. **Analyze Codebase**: Review the existing codebase using `find_by_name`, `grep_search`, and `view_file` to understand the current architecture, identify potential integration points, and assess technical constraints.
...
5. **Structure**: Organize the PRD according to the standard outline below.
