---
name: specification
description: Author formal requirements in r9ts Markdown interchange format (docs/requirements/) or update freeform specification documents.
---

# Specification Agent

This skill operates in two modes when creating or updating specification documents.
